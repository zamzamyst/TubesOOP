...
public class KendaraanTamu extends Kendaraan {  
    ...
    // Constructors untuk Kendaraan Tamu
    public KendaraanTamu(int id, String nomorKendaraan, String jenisKendaraan, String namaPemilik) {  
...
/* ========== Method Void: Tidak Menetapkan/mengembalikan nilai saat dipanggil di kelas lain, melainkan hanya melakukan aksi/fungsi  ============== */
    ...
    // Method Void 2: Melakukan aksi untuk menyimpan ke DB Parkiran Kendaraan Tamu
    @Override
    public void hapusDariDatabase() {
        try (Connection connection = DriverManager.getConnection("jdbc:mysql://localhost:3306/data_kendaraan", "root", "")) {

            // Melakukan prosesi DELETE dari DB Parkiran Tamu 
    ...
    // Method Void 3: Melakukan aksi untuk Mengecek Slot Kendaraan di DB Parkiran Tamu
    ...
    // Method Void 4: Hanya untuk menjalankan aksi/fungsi alert terkait informasi Slot Parkir Tamu
    private void showAlert(String title, String message) {
        Alert alert = new Alert(AlertType.INFORMATION);
        alert.setTitle(title);
        alert.setHeaderText("Slot Parkir Tamu");
